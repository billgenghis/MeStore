...
//
//import com.smartx.bill.mepad.mestore.uimgloader.Constants;
//
...
//			return false;
//		}
////		context.grantUriPermission("com.smartx.bill.mepad.mestore", Uri.parse("content://downloads/all_downloads"), Intent.FLAG_GRANT_READ_URI_PERMISSION | Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
...
//			mimeType = getOriginalMimeType(context, file, mimeType);
//
